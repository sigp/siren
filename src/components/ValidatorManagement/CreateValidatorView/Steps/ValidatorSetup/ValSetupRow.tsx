...
const ValSetupRow:FC<ValSetupRowProps> = ({index, candidate, onUpdateCandidate, onRemoveCandidate}) => {
  const { id } = candidate
    ...
    <ValidatorCandidateRow index={index + 1} data={candidate} onUpdateCandidate={onUpdateCandidate}>
      <div className="flex relative items-center">
        ...
        <div className="cursor-pointer p-4 border-l-style">
          <IconButton buttonType={IconButtonTypes.TERTIARY} onClick={removeCandidate} icon="bi-dash-circle"/>
        </div>
      </div>
