...
const HardwareInfo = () => {
  return (
      <div className="h-full w-full flex flex-col min-w-316">
          <div className="w-full h-12 border flex border-style500">
              <div className="flex-1 flex items-center justify-center cursor-pointer">
                <Typography type="text-caption1" color="text-primary" darkMode="dark:text-white" isBold>Hardware Usage</Typography>
              </div>
              <div className="flex-1 flex items-center justify-center cursor-pointer">
                  <Typography type="text-caption1" color="text-dark500">Hardware Usage</Typography>
              </div>
          </div>
