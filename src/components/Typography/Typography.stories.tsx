...
const Template: Story<TypographyProps> = ({ children, ...args }) => {
    const settings: TypographyType[] = ['text-caption2' , 'text-caption1' , 'text-body' , 'text-subtitle2' , 'text-subtitle1' , 'text-h3' , 'text-h2' , 'text-h1' , 'text-title'];

    return (
        <ul className="p-0 border-none">
            {settings.map((tag, index) => (
                <li
                    className="flex items-center border-b border-black py-4"
                    key={index}>
