    ...
    <div className={className}>
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <i onClick={decrementIndex} className="bi-chevron-left cursor-pointer text-xs dark:text-dark300"/>
          <i onClick={incrementIndex} className="bi-chevron-right cursor-pointer text-xs dark:text-dark300"/>
        </div>
      </div>
      <div className="flex items-center justify-between">
        <Typography color="text-dark300" isCapitalize type="text-caption1">{t(activeIncomeTimeFrame.title)}</Typography>
