             ...
             <div className="space-y-4">
                 ...
                 <div className="flex w-44 items-center">
                     ...
                     <Controller
                         ...
                         control={control}
                         render={({field: {ref: _ref, value}}) => (
                             <input className="text-subtitle2 flex-1 bg-transparent text-white outline-none" type="text" value={value} onChange={onChangeAddress} />
                         )}
                     />
                 </div>
             </div>
                 ...
                 !type ? (
                         ...
                         <div className="space-y-4">
                             ...
                             <Controller
                                 ...
                                 render={({field: {ref: _ref, ...props}}) => (
                                     <input className="text-subtitle2 w-20 bg-transparent text-white outline-none appearance-none" type="number" {...props} />
                                 )}
                             />
                         </div>
                         <div className="space-y-4">
                     ...
                     <div className="space-y-4">
                         ...
                         <Controller
                             ...
                             control={control}
                             render={({field: {ref: _ref, value}}) => (
                                 <input className="text-subtitle2 w-20 bg-transparent text-white outline-none appearance-none" type="number" value={value} onChange={onChangePort} />
                             )}
                         />
                     </div>
                 )
